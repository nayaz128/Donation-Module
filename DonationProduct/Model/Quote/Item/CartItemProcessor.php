...
namespace Navyug\DonationProduct\Model\Quote\Item;

use Navyug\DonationProduct\Helper\Serializer;
use Navyug\DonationProduct\Model\DonationOptionsFactory;
 ...
 * @package Navyug\DonationProduct\Model\Quote\Item
 */
    ...
    public function processOptions(CartItemInterface $cartItem)
    {
        ...
        if (!empty($options) && is_array($options)) {
            foreach ($options as $name => $value) {
                /** @var \Navyug\DonationProduct\Model\DonationOptions $donationOptions */
