define([
    ...
    $.widget('mage.donation', {
        ...
        initDonationModal: function () {
            ...
            var pMinLabel = $('.Navyug-donation-minimal-amount-label-' + this.options.identifier);
            ...
            $('html').on('click', this.options.productSelector, function () {
                ...
                if (charity.data('productid') != '') {
                    ...
                    $('.Navyug-donation-modal')
                        .modal(options)
                        .modal('openModal');

                    $('.Navyug-modal-popup .modal-title').text(title);
                }
            });
