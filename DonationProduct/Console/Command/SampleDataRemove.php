...
namespace Navyug\DonationProduct\Console\Command;
...
class SampleDataRemove extends Command
{
    ...
    public function __construct(
        \Navyug\DonationProduct\Model\SampleData $donationSampleDataModel,
    ...
    {
        $this->setName("Navyug_donationproduct:sampledata:remove");
